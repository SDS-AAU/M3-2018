---
title: 'M3-1: Introduction to Artificial Neural Networks and Deep Learning'
...
# knit: markdowntemplates::to_jupyter # Find out what's theproblem with this fuck
---
...
# Introduction to Artificial Intelligence (AI), Artificial Neural Networks (ANN), and Deep Learning (DL)
...
![](../media/dl_overview.png){width=500px}
...
![](../media/AI_types.png){width=500px}
...
![](../media/perceptron.png){width=300px}
...
![](../media/neural_net3.png){width=500px}
...
```{r, include=FALSE}
rm(data, index, test, train, fit.nnet)
```


### A brief history of ANNs and DL
...
![](../media/ML_timeline.png){width=500px}
...
![](../media/dl_concept_1.jpg){width=500px}
...
![](../media/dl_concept_2.jpg){width=500px}
...
Keras is a deep-learning framework that provides a convenient way to define and train almost any kind of deep-learning model. Keras was initially developed for researchers, with the aim of enabling fast experimentation. It has the following 
...
<img width="45%" src="../media/dl_frameworks_1.jpg"/>
<img width="45%" src="../media/dl_frameworks_2.jpg"/>
...
![](../media/keras_wtf.png){width=500px}
...
### Arrays (3D tensors and higher-dimensional tensors)
...
![](../media/tensor_3d.jpg){width=250px}
...
![](../media/tensor_4d.jpg){width=250px}
...
![](../media/vector_1.jpg){width=250px}
...
![](../media/vector_2.jpg){width=250px}
...
![](../media/gradient_1.jpg){width=250px}
...
![](../media/gradient_2.jpg){width=250px}
...
![](../media/gradient_3.jpg){width=250px}
...
![](../media/activation_1.jpg){width=250px}
...
![](../media/activation_2.jpg){width=250px}
...
![](../media/table_ann_config.png){width=300px}
...
Well, its that point of the session again... [HERE](https://www.kaggle.com/danielhain/sds-2018-m3-1-supervised-ml-exercise-1) some well-known data, but new model architectures await you...
